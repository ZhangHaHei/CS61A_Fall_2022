...
def next_perfect_square(score):
    return pow(int(pow(score, 0.5)) + 1, 2)
# END PROBLEM 4
...
def tail_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    score_temp = tail_points(opponent_score)
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    score_temp = square_update(0, score, opponent_score)
    if score_temp - score >= threshold:
        num_rolls = 0
